        ...
        void Filter()
        {
            using (UnitOfWork db = new UnitOfWork())
            {
                ...
                if ((int)cbCustomer.SelectedValue != 0)
                {
                    ...
                    result.AddRange(db.AccountingRepository.Get(a => a.TypeID == TypeID && a.Customer_ID == customerId));
                }
                else
                {
                ...
                {
                    string customerName = db.CustomerRepository.GetCustomerNameById(accounting.Customer_ID);
                    dgReport.Rows.Add(accounting.ID, customerName, accounting.Amount, accounting.DataTitle.ToShamsi(),accounting.Description);
                }
            }
